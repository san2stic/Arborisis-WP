    ...
    <div class="container-custom max-w-6xl">
                ...
                <div class="flex flex-col md:flex-row gap-8">
                    ...
                    <div class="flex-1">
                        <div class="flex items-start justify-between mb-4">
                            <div>
                                <h1 class="text-3xl md:text-4xl font-display font-bold text-dark-900 dark:text-dark-50 mb-2">
                        ...
                        <div class="grid grid-cols-3 gap-4 mb-6">
                            <div class="text-center p-4 bg-dark-50 dark:bg-dark-800 rounded-lg">
                                <div class="text-2xl font-bold text-primary-600 dark:text-primary-400" id="sounds-count">-</div>
                                <div class="text-xs uppercase tracking-wide text-dark-600 dark:text-dark-400 mt-1">Sons</div>
                            </div>
                            <div class="text-center p-4 bg-dark-50 dark:bg-dark-800 rounded-lg">
                                <div class="text-2xl font-bold text-primary-600 dark:text-primary-400"><?php echo number_format($total_plays); ?></div>
                                <div class="text-xs uppercase tracking-wide text-dark-600 dark:text-dark-400 mt-1">Écoutes</div>
                            </div>
                            <div class="text-center p-4 bg-dark-50 dark:bg-dark-800 rounded-lg">
                                <div class="text-2xl font-bold text-primary-600 dark:text-primary-400"><?php echo number_format($total_likes); ?></div>
                                <div class="text-xs uppercase tracking-wide text-dark-600 dark:text-dark-400 mt-1">Likes</div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-wrap gap-3">
                            ...
                            <?php endif; ?>
                            <?php if ($twitter) : ?>
                                <a href="https://twitter.com/<?php echo esc_attr($twitter); ?>" target="_blank" class="btn btn-ghost btn-sm">
                            ...
                            <?php endif; ?>
                            <?php if ($instagram) : ?>
                                <a href="https://instagram.com/<?php echo esc_attr($instagram); ?>" target="_blank" class="btn btn-ghost btn-sm">
                                    <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="mb-8">
            <div class="flex gap-2 border-b border-dark-200 dark:border-dark-700">
                <button class="tab-btn px-6 py-3 font-medium border-b-2 border-primary-600 text-primary-600" data-tab="sounds">
                    Enregistrements
                </button>
                <button class="tab-btn px-6 py-3 font-medium border-b-2 border-transparent text-dark-600 dark:text-dark-400 hover:text-dark-900 dark:hover:text-dark-50" data-tab="stats">
                    Statistiques
                </button>
                <?php if ($is_own_profile) : ?>
                    <button class="tab-btn px-6 py-3 font-medium border-b-2 border-transparent text-dark-600 dark:text-dark-400 hover:text-dark-900 dark:hover:text-dark-50" data-tab="favorites">
                        Favoris
                    </button>
                <?php endif; ?>
            </div>
