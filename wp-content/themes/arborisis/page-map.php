...
<div class="map-container">
            ...
            <div class="pointer-events-auto">
                <div class="glass dark:glass-dark rounded-xl p-4 shadow-xl">
                    ...
                    <div class="space-y-2 text-sm">
                        ...
                        <div class="flex items-center gap-2">
                            <div class="w-8 h-8 bg-secondary-500 rounded-full shadow-glow-lg flex items-center justify-center text-white text-xs font-bold">5+</div>
    ...
    <div id="sound-popup" class="hidden absolute bottom-8 left-1/2 -translate-x-1/2 z-20 pointer-events-auto max-w-md w-full mx-4">
        <div class="card shadow-2xl">
            <div class="card-body">
                <button id="close-popup" class="absolute top-4 right-4 w-8 h-8 hover:bg-dark-100 dark:hover:bg-dark-700 rounded-lg flex items-center justify-center transition-colors">
