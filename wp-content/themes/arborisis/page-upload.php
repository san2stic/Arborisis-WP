        ...
        <form id="upload-form" class="space-y-6">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="drop-zone" class="border-2 border-dashed border-dark-300 dark:border-dark-600 rounded-xl p-12 text-center cursor-pointer hover:border-primary-500 hover:bg-primary-50 dark:hover:bg-primary-900/10 transition-all">
                        ...
                        <input type="file" id="audio-file" accept="audio/mpeg,audio/wav,audio/flac,audio/ogg,audio/mp4" class="hidden">
                        <button type="button" onclick="document.getElementById('audio-file').click()" class="btn btn-primary">
                            Choisir un fichier
                        </button>
                    </div>
                    ...
                    <div id="file-info" class="hidden mt-4 p-4 bg-dark-50 dark:bg-dark-800 rounded-lg">
                        ...
                        <div id="upload-progress" class="hidden mt-4">
                            ...
                            <div class="w-full h-2 bg-dark-200 dark:bg-dark-700 rounded-full overflow-hidden">
                                <div id="progress-bar" class="h-full bg-primary-600 transition-all duration-300" style="width: 0%"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="title" name="title" required class="input" placeholder="Ex: Forêt au petit matin">
                        </div>

                        <div>
                            <label for="description" class="block text-sm font-medium mb-2">Description</label>
                            <textarea id="description" name="description" rows="4" class="input" placeholder="Décrivez votre enregistrement, le contexte, les sons capturés..."></textarea>
                        </div>

                        <div>
                            <label for="tags" class="block text-sm font-medium mb-2">Tags</label>
                            <input type="text" id="tags" name="tags" class="input" placeholder="nature, oiseaux, forêt (séparés par des virgules)">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-dark-500 mt-1">
                                <a href="https://creativecommons.org/licenses/" target="_blank" class="hover:text-primary-600">En savoir plus sur les licences Creative Commons</a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="location-name" name="location_name" class="input" placeholder="Ex: Forêt de Fontainebleau, France">
                        </div>

                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label for="latitude" class="block text-sm font-medium mb-2">Latitude</label>
                                <input type="number" id="latitude" name="latitude" step="0.000001" class="input" placeholder="48.404722">
                            </div>
                            <div>
                                <label for="longitude" class="block text-sm font-medium mb-2">Longitude</label>
                                <input type="number" id="longitude" name="longitude" step="0.000001" class="input" placeholder="2.707778">
                            </div>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label for="recorded-at" class="block text-sm font-medium mb-2">Date d'enregistrement</label>
                        ...
                        <div>
                            ...
                            <input type="text" id="equipment" name="equipment" class="input" placeholder="Ex: Zoom H5, Rode NTG-2">
                        </div>
                    </div>
                </div>
            </div>
